...
<textarea name="{$redactor_name}" id="{$redactor_id}" class="redactor_{$redactor_type} js-redactor" data-type="{$redactor_type}" style="min-height: 150px" rows="5" cols="50">{$redactor_value|stripslashes}</textarea>
