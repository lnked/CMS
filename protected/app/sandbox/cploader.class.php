...
class CPLoader extends CPInit
{
    ...
    private function reactFiles()
    {
        ...
        $files = scanDIRR(PATH_ADMIN.DS.'react');
    ...
    public function run()
    {
        ...
        $this->viewer->assign('isReact', $this->isReact());
        $this->viewer->assign('reactFiles', $this->reactFiles());
        ...
        $this->viewer->assign('PATH_PUBLIC', '/static/apps');
